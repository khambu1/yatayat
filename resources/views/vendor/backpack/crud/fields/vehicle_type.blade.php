<div class="row col-md-12 if_bus m-1">
    ...
    <div class="col-md-6 row bold-labels">
        ...
        <div class="form-group col-md-8">
            ...
            <input type="number" name="right_column" class="form-control" value="{{ old('right_column') }}" id="right_column" placeholder="Fill value in Right Row first.">
        </div>
        <div class="form-group col-md-8">
        ...
        <div class="form-group col-md-8">
            ...
            <input type="number" name="left_column" class="form-control" value="{{ old('left_column') }}" id="left_column" placeholder="Fill value in Left Row first.">
        </div>
    </div>
